...
Mission save backups use `fms/*/savegames/**/*` relative to the installation root, following the engine's per-mission save directory. The packaged title artwork is the unmodified [official website title image](https://www.thedarkmod.com/wp-content/themes/thedarkmod/images/tdm_title.png), credited to Team Dark Mod and used to identify their game; it is not original Gameflow artwork.
